...
CREATE TABLE subscription(id int AUTO_INCREMENT PRIMARY KEY, mailing boolean,modules varchar(15000) not null,structure_id int not null,FOREIGN KEY(structure_id) REFERENCES structures(id));
