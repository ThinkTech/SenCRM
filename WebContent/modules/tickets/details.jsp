...
<div id="content">
<h1 class="icon-32">Ticket : ${ticket.id} <a title="Help" class="help-16">Help</a> <a title="Refresh" class="refresh-16" style="display:${ticket.dateClose==null ? 'inline-block':'none'}">Refresh</a> <a href="tickets/createTicket" title="Create Ticket" class="new-16">Create</a>  <a class="back-16" href="${ticket.dateClose==null ? 'tickets' :'tickets/closed'}" title="Back">Back</a>  <a href="tickets/closeTicket?id=${ticket.id}" title="Close it now" class="icon-16" onclick="return closeTicket(event,'Are you sure that you want to close this ticket?');" style="display:${ticket.dateClose==null ? 'block':'none'}">Close it now</a></h1>
